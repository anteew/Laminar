...
export function resolveContext(params) {
    ...
    const cfgReports = cfg?.reportsDir;
    const cfgHistory = cfg?.historyFile;
    const cfgLane = cfg?.lanes?.auto;
    // Reports dir & history
...
export function resolveReportsAbsolute(root, reportsDir) {
